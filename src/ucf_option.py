...
parser.add_argument('--visual-length', default=256, type=int)  # 帧长（裁剪或填充后的统一长度）
parser.add_argument('--visual-width', default=512, type=int)  # 单帧的dim
...
parser.add_argument('--model-path', default='../model/model_ucf_noavg_pad.pth')
